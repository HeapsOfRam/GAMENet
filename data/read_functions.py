...
ndc2atc_file = '{}ndc2atc_level4.csv'.format(path_prefix)
cid_atc = '{}drug-atc.csv'.format(path_prefix)
ndc2rxnorm_file = '{}ndc2rxnorm_mapping.txt'.format(path_prefix)

# drug-drug interactions can be down https://www.dropbox.com/s/8os4pd2zmp2jemd/drug-DDI.csv?dl=0
#ddi_file = 'drug-DDI.csv'
ddi_file = '{}drug-DDI.csv'.format(path_prefix)
